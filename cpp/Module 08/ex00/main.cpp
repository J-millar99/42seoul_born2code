...
int main()
{
    ...
    {
        std::cerr << "Error: " << e.what() << "(const vector)" << std::endl;
    }
    ...
    {
        std::cerr << "Error: " << e.what() << "(const list)" << std::endl;
    }
    ...
    {
        std::cerr << "Error: " << e.what() << "(const deque)" << std::endl;
    }
    return 0;
}